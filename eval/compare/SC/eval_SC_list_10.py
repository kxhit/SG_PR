...
if __name__ == '__main__':
    list_dir = "/media/datasets/kx/code/SimGNN_semantic/eval/10_20/"
    pair_dir = "/media/datasets/yxm/graph_pairs_sem_10_20_ds"
    ...
    for sequence in tqdm(sequences):
        ...
        # choose output path
        output_path = "/media/datasets/kx/code/SimGNN_semantic/eval/compare/ScanContext/list/10_20/drop0/" + sequence + "/"
