...
def main():
    ...
    # p_thresh = str(10)
    if method == "SK":
        pair_dir = "/media/work/data/kitti/odometry/semantic-kitti/" + \
                   p_thresh + "_20/graph_pairs_sem_"+ p_thresh + "_20_ds/"
    elif method == "RN":
        pair_dir = "/media/work/data/kitti/odometry/semantic-kitti/" + \
                   p_thresh + "_20/graph_pairs_darknet53_" + p_thresh + "_20_ds/"
    else:
    ...
    for sequence in tqdm(sequences):
        ...
        # todo
        if method == "SK":
            output_path = eval_dir + "/" + p_thresh + "_20/" + "Ours_SK/" + "drop0/" + sequence + "/"
        elif method == "RN":
            output_path = eval_dir + "/" + p_thresh + "_20/" + "Ours_RN/" + "drop0/" + sequence + "/"
        else:
            print("method error: ", method)
            exit(-1)
        print(output_path)
        ...
        list_path = eval_dir + "/gt/" + p_thresh + "_20/draw_curve_" + sequence + ".npy"
        ...
        for pair in tqdm(pairs_files):
            pair_file = os.path.join(pairs_path, pair)
