...
class sgpr_args():
    ...
    def load(self,config_file):
        ...
        #train
        self.graph_pairs_dir=config_args['train']['graph_pairs_dir']
        self.p_thresh=config_args['train']['p_thresh']
        self.batch_size=config_args['train']['batch_size']
        ...
        #evo
        self.model=config_args['evo']['model']
